...
def main():
    ...
    parser.add_argument("--output_dir", default='run_glue_test', type=str, required=True, help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--window_size", type=int, required=True, help="The window size.")                    
    parser.add_argument("--max_seq_length", default=105, type=int, help="The maximum total input sequence length after tokenization. Sequences longer than this will be truncated, sequences shorter will be padded.")
    parser.add_argument("--do_train", action='store_true', help="Whether to run training.")
    parser.add_argument("--do_test", action='store_true', help="Whether to run test set.")
